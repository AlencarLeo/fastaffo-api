...
namespace fastaffo_api.src.Infrastructure.Migrations
{
    ...
    [Migration("20250209040005_NewJobReqProps")]
    partial class NewJobReqProps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fastaffo_api.src.Domain.Entities.Job", b =>
                {
                    ...
                    b.Property<bool>("AcceptingReqs")
                        .HasColumnType("bit");

                    b.PrimitiveCollection<string>("AllowedForJobStaffIds")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<float?>("JobDuration")
                        .HasColumnType("real");

                    b.Property<int>("JobNumber")
                        .HasColumnType("int");

                    b.Property<DateTimeOffset>("LocalStartDateTime")
                    ...
                    b.Property<string>("StartDateTimeZoneLocation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<float?>("TotalChargedValue")
                        .HasColumnType("real");

                    b.Property<DateTimeOffset>("UtcStartDateTime")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("fastaffo_api.src.Domain.Entities.JobRequest", b =>
                {
                    b.HasOne("fastaffo_api.src.Domain.Entities.UserAdmin", "Admin")
                        .WithMany()
