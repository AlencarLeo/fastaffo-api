...
namespace fastaffo_api.src.Infrastructure.Migrations
{
    ...
    [Migration("20250104081125_NewJobRelationsEntities")]
    partial class NewJobRelationsEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("fastaffo_api.src.Domain.Entities.Job", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("JobRequestsId")
                        .HasColumnType("nvarchar(max)");

                    b.PrimitiveCollection<string>("JobStaffsId")
                        .HasColumnType("nvarchar(max)");
